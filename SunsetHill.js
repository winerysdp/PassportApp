...
constructor(props) {
	...
	goToMap() {
		if (Platform.OS === 'ios') {
			...
			Linking.openURL('https://www.google.com/maps/dir/?api=1&destination=5+Elys+Ferry+Road%2C+Lyme%2C+CT')
		}
	}
	displayStamp() {
		if (stamped[32]) {
			...
			<ScrollView contentContainerStyle={styles.contentContainer}>
				...
				<TextInput
					...
					numberofLines = {4}
					 onChangeText={(text) => { 
						this.setState({text});
						AsyncStorage.setItem('SunsetHill', text); // Note: persist input
					 }}
