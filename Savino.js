...
class winery {
	...
	goToMap() {
		if (Platform.OS === 'ios') {
			...
			Linking.openURL('geo:128+Ford+Road%2C+Woodbridge%2C+CT')
		}
	}
}

var name = "Savino Vineyards";
var address = "128 Ford Road, Woodbridge, CT 06525";
var description = "Savino Vineyards is a small family owned and operated vineyard situated 400 feet above sea level on eight acres of pristine land in the town of Woodbridge, Connecticut. We grow premium Vitis vinifera grapes and American hybrids to blend and produce unique tasting wines.";
