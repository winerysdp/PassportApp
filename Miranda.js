...
constructor(props) {
	...
	goToMap() {
		if (Platform.OS === 'ios') {
			...
			Linking.openURL('https://www.google.com/maps/dir/?api=1&destination=42+Ives+Road%2C+Goshen%2C+CT')
		}
	}
	displayStamp() {
		if (stamped[21]) {
			...
			<ScrollView contentContainerStyle={styles.contentContainer}>
				...
				<TextInput
					...
					numberofLines = {4}
					 onChangeText={(text) => { 
						this.setState({text});
						AsyncStorage.setItem('Miranda', text); // Note: persist input
					 }}
