...
export default class Brignole extends Component {
constructor(props) {
		super(props);
		this.state = {text: ""};
		this.name = "Brignole Vineyards";
		this.pic = require('./assets/wine4.jpg');
	...
	goToMap() {
		if (Platform.OS === 'ios') {
			...
			Linking.openURL('https://www.google.com/maps/dir/?api=1&destination=103+Hartford+Avenue+East+Granby+CT')
		}
	}
	displayStamp() {
		if (stamped[3]) {
