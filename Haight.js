...
class winery {
	...
	goToMap() {
		if (Platform.OS === 'ios') {
			...
			Linking.openURL('geo:29+Chestnut+Hill+Road%2C+Litchfield%2C+CT')
		}
	}
}

var name = "Haight-Brown Vineyard";
var address = "29 Chestnut Hill Road, Litchfield, CT 06759";
var description = "Connecticut’s oldest vineyard located on historic Chestnut Hill Road in Litchfield. Enjoy the rustic setting amongst the natural beauty of the Litchfield Hills.";
