...
export default class Jonathan extends Component {
constructor(props) {
		super(props);
		this.state = {text: ""};
	...
	goToMap() {
		if (Platform.OS === 'ios') {
			...
			Linking.openURL('https://www.google.com/maps/dir/?api=1&destination=74+Chester+Main+Road%2C+North+Stonington%2C+CT')
		}
	}
	displayStamp() {
		if (stamped[15]) {
