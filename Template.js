...
constructor(props) {
		...
		this.pic = require('./assets/WineryNameWine.jpg');
		this.phone = 'Vineyard Phone Number';
	...
	componentDidMount() {
		AsyncStorage.getItem('WineryName').then((value) => {
		if (value !== null){
			...
			<ScrollView contentContainerStyle={styles.contentContainer}>
				...
				<TextInput
					...
					numberofLines = {4}
					 onChangeText={(text) => { 
						this.setState({text});
						AsyncStorage.setItem('WineryName', text); // Note: persist input
					 }}
