...
class winery {
	...
	goToMap() {
		if (Platform.OS === 'ios') {
			...
			Linking.openURL('geo:32+Route+37+East%2C+Sherman%2C+CT')
		}
	}
}
var name = "White Silo Winery";
var address = "32 Route 37 East, Sherman, CT 06784";
var description = "A family owned winery producing award winning grape and fruit wines. The 18th century dairy barn has been renovated to create an elegant tasting room. Enjoy your wine and picnic lunch on our new outdoor patio overlooking the farm and vineyard. See our website for information about annual festivals, special events, and private event information. We are handicap accessible.";
