...
export default class Rosabianca extends Component {
constructor(props) {
		super(props);
		this.state = {text: ""};
	...
	goToMap() {
		if (Platform.OS === 'ios') {
			...
			Linking.openURL('https://www.google.com/maps/dir/?api=1&destination=1536+Middletown+Avenue%2C+Northford%2C+CT')
		}
	}
	displayStamp() {
		if (stamped[25]) {
