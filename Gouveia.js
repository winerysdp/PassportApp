...
export default class Gouveia extends Component {
constructor(props) {
		super(props);
		this.state = {text: ""};
	...
	goToMap() {
		if (Platform.OS === 'ios') {
			...
			Linking.openURL('https://www.google.com/maps/dir/?api=1&destination=1339+Whirlwind+Hill+Road%2C+Wallingford%2C+CT')
		}
	}
	displayStamp() {
		if (stamped[9]) {
